  ...
  return (
   <>
    <Modal ref={dialog} buttonCaption="close">
      <h2 className='text-xl text-bold text-stone-700 mt-4 my-4'>Invalid Input.</h2>
      <p className='text-stone-6 00 mb-4'>Please...Input all the value for every inputs.</p>
    </Modal>
